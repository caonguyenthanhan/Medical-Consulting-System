...
- Các lệnh ví dụ: `cd medical-consultation-app; npm install; npm run dev`.
- Tránh cú pháp bash; sử dụng PowerShell cho hướng dẫn chạy và kiểm thử cục bộ.
...
- **Audio**: `webm/opus` input cho STT, đảm bảo sample rate phù hợp
- **Image**: Base64 JPEG/PNG không kèm prefix `data:image/...;base64,`
- **Permissions**: Yêu cầu HTTPS để truy cập camera/micro trên trình duyệt
