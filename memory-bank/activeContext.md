...
### Hoàn thiện dự án & Tài liệu hóa (20/12/2025)
- **Dọn dẹp dự án**: 
  - Xóa các file cache (`__pycache__`, `*.pyc`), log (`*.log`, `*.jsonl`), và file tạm (`audio/*.mp3`).
  - Cập nhật `.gitignore` để loại bỏ file rác và bảo mật file nhạy cảm.
- **Tài liệu hóa**:
